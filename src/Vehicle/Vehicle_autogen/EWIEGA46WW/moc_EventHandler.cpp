...
#include <memory>
#include "../../../../../qgroundcontrol/src/Vehicle/EventHandler.h"
...
QT_MOC_LITERAL(1, 13, 28), // "healthAndArmingChecksUpdated"
QT_MOC_LITERAL(2, 42, 0) // ""

    },
    "EventHandler\0healthAndArmingChecksUpdated\0"
    ""
};
...
void EventHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventHandler::healthAndArmingChecksUpdated)) {
                *result = 0;
                return;
            }
        }

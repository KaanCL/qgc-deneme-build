...
#include <memory>
#include "../../../../../qgroundcontrol/src/Vehicle/VehicleHygrometerFactGroup.h"
...
struct qt_meta_stringdata_VehicleHygrometerFactGroup_t {
    QByteArrayData data[5];
    char stringdata0[61];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_VehicleHygrometerFactGroup_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_VehicleHygrometerFactGroup_t qt_meta_stringdata_VehicleHygrometerFactGroup = {
    {
QT_MOC_LITERAL(0, 0, 26), // "VehicleHygrometerFactGroup"
QT_MOC_LITERAL(1, 27, 7), // "hygroID"
QT_MOC_LITERAL(2, 35, 5), // "Fact*"
QT_MOC_LITERAL(3, 41, 9), // "hygroTemp"
QT_MOC_LITERAL(4, 51, 9) // "hygroHumi"

    },
    "VehicleHygrometerFactGroup\0hygroID\0"
    "Fact*\0hygroTemp\0hygroHumi"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_VehicleHygrometerFactGroup[] = {
...
QT_INIT_METAOBJECT const QMetaObject VehicleHygrometerFactGroup::staticMetaObject = { {
    QMetaObject::SuperData::link<FactGroup::staticMetaObject>(),
    qt_meta_stringdata_VehicleHygrometerFactGroup.data,
    qt_meta_data_VehicleHygrometerFactGroup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VehicleHygrometerFactGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VehicleHygrometerFactGroup.stringdata0))

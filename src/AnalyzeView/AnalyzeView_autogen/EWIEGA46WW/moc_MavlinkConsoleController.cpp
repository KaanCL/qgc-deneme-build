...
QT_MOC_LITERAL(19, 185, 15), // "handleClipboard"
QT_MOC_LITERAL(20, 201, 11), // "command_pre"
QT_MOC_LITERAL(21, 213, 4) // "text"
    ...
    "historyUp\0current\0historyDown\0"
    "handleClipboard\0command_pre\0text"
};
...
static const uint qt_meta_data_MavlinkConsoleController[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       ...
       5,    5,   47,    2, 0x08 /* Private */,

 // methods: name, argc, parameters, tag, flags
      14,    1,   58,    2, 0x02 /* Public */,
      16,    1,   61,    2, 0x02 /* Public */,
      18,    1,   64,    2, 0x02 /* Public */,
      19,    1,   67,    2, 0x02 /* Public */,
...
void MavlinkConsoleController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: { QString _r = _t->historyDown((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 5: { QString _r = _t->handleClipboard((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }

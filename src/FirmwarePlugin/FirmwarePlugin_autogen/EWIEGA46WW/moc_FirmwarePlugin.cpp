...
QT_MOC_LITERAL(1, 15, 21), // "toolIndicatorsChanged"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 21) // "modeIndicatorsChanged"

    },
    "FirmwarePlugin\0toolIndicatorsChanged\0"
    "\0modeIndicatorsChanged"
};
...
void FirmwarePlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FirmwarePlugin::toolIndicatorsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FirmwarePlugin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FirmwarePlugin::modeIndicatorsChanged)) {
                *result = 1;
                return;
            }
        }

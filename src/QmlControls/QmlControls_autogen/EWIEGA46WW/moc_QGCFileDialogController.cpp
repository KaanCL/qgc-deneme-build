...
QT_MOC_LITERAL(4, 48, 11), // "nameFilters"
QT_MOC_LITERAL(5, 60, 22), // "fullyQualifiedFilename"
QT_MOC_LITERAL(6, 83, 8), // "filename"
QT_MOC_LITERAL(7, 92, 10), // "fileExists"
QT_MOC_LITERAL(8, 103, 10), // "deleteFile"
QT_MOC_LITERAL(9, 114, 14), // "urlToLocalFile"
QT_MOC_LITERAL(10, 129, 3), // "url"
QT_MOC_LITERAL(11, 133, 31), // "fullFolderPathToShortMobilePath"
QT_MOC_LITERAL(12, 165, 14) // "fullFolderPath"

    },
    "QGCFileDialogController\0getFiles\0\0"
    "directoryPath\0nameFilters\0"
    "fullyQualifiedFilename\0filename\0"
    "fileExists\0deleteFile\0urlToLocalFile\0"
    "url\0fullFolderPathToShortMobilePath\0"
    "fullFolderPath"
};
...
static const uint qt_meta_data_QGCFileDialogController[] = {
 ...
 // methods: name, argc, parameters, tag, flags
       ...
       5,    3,   54,    2, 0x02 /* Public */,
       5,    2,   61,    2, 0x22 /* Public | MethodCloned */,
...
void QGCFileDialogController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { QString _r = _t->fullyQualifiedFilename((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const QStringList(*)>(_a[3])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 2: { QString _r = _t->fullyQualifiedFilename((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        ...
        case 5: { QString _r = _t->urlToLocalFile((*reinterpret_cast< QUrl(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 6: { QString _r = _t->fullFolderPathToShortMobilePath((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }

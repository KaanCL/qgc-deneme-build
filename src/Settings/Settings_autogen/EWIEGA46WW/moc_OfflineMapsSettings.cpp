...
#include <memory>
#include "../../../../../qgroundcontrol/src/Settings/OfflineMapsSettings.h"
...
struct qt_meta_stringdata_OfflineMapsSettings_t {
    QByteArrayData data[5];
    char stringdata0[88];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OfflineMapsSettings_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OfflineMapsSettings_t qt_meta_stringdata_OfflineMapsSettings = {
    {
QT_MOC_LITERAL(0, 0, 19), // "OfflineMapsSettings"
QT_MOC_LITERAL(1, 20, 20), // "minZoomLevelDownload"
QT_MOC_LITERAL(2, 41, 5), // "Fact*"
QT_MOC_LITERAL(3, 47, 20), // "maxZoomLevelDownload"
QT_MOC_LITERAL(4, 68, 19) // "maxTilesForDownload"

    },
    "OfflineMapsSettings\0minZoomLevelDownload\0"
    "Fact*\0maxZoomLevelDownload\0"
    "maxTilesForDownload"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_OfflineMapsSettings[] = {
...
QT_INIT_METAOBJECT const QMetaObject OfflineMapsSettings::staticMetaObject = { {
    QMetaObject::SuperData::link<SettingsGroup::staticMetaObject>(),
    qt_meta_stringdata_OfflineMapsSettings.data,
    qt_meta_data_OfflineMapsSettings,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *OfflineMapsSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OfflineMapsSettings.stringdata0))

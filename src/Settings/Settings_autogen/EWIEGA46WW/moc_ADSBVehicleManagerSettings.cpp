...
#include <memory>
#include "../../../../../qgroundcontrol/src/Settings/ADSBVehicleManagerSettings.h"
...
struct qt_meta_stringdata_ADSBVehicleManagerSettings_t {
    QByteArrayData data[5];
    char stringdata0[95];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ADSBVehicleManagerSettings_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ADSBVehicleManagerSettings_t qt_meta_stringdata_ADSBVehicleManagerSettings = {
    {
QT_MOC_LITERAL(0, 0, 26), // "ADSBVehicleManagerSettings"
QT_MOC_LITERAL(1, 27, 24), // "adsbServerConnectEnabled"
QT_MOC_LITERAL(2, 52, 5), // "Fact*"
QT_MOC_LITERAL(3, 58, 21), // "adsbServerHostAddress"
QT_MOC_LITERAL(4, 80, 14) // "adsbServerPort"

    },
    "ADSBVehicleManagerSettings\0"
    "adsbServerConnectEnabled\0Fact*\0"
    "adsbServerHostAddress\0adsbServerPort"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_ADSBVehicleManagerSettings[] = {
...
QT_INIT_METAOBJECT const QMetaObject ADSBVehicleManagerSettings::staticMetaObject = { {
    QMetaObject::SuperData::link<SettingsGroup::staticMetaObject>(),
    qt_meta_stringdata_ADSBVehicleManagerSettings.data,
    qt_meta_data_ADSBVehicleManagerSettings,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ADSBVehicleManagerSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ADSBVehicleManagerSettings.stringdata0))

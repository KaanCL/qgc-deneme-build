...
#include <memory>
#include "../../../../../qgroundcontrol/src/MissionManager/SurveyPlanCreator.h"
...
struct qt_meta_stringdata_SurveyPlanCreator_t {
    QByteArrayData data[5];
    char stringdata0[60];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SurveyPlanCreator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SurveyPlanCreator_t qt_meta_stringdata_SurveyPlanCreator = {
    {
QT_MOC_LITERAL(0, 0, 17), // "SurveyPlanCreator"
QT_MOC_LITERAL(1, 18, 10), // "createPlan"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 14), // "QGeoCoordinate"
QT_MOC_LITERAL(4, 45, 14) // "mapCenterCoord"

    },
    "SurveyPlanCreator\0createPlan\0\0"
    "QGeoCoordinate\0mapCenterCoord"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_SurveyPlanCreator[] = {
...
QT_INIT_METAOBJECT const QMetaObject SurveyPlanCreator::staticMetaObject = { {
    QMetaObject::SuperData::link<PlanCreator::staticMetaObject>(),
    qt_meta_stringdata_SurveyPlanCreator.data,
    qt_meta_data_SurveyPlanCreator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SurveyPlanCreator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SurveyPlanCreator.stringdata0))

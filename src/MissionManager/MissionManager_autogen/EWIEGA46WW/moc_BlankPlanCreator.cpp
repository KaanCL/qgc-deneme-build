...
#include <memory>
#include "../../../../../qgroundcontrol/src/MissionManager/BlankPlanCreator.h"
...
struct qt_meta_stringdata_BlankPlanCreator_t {
    QByteArrayData data[5];
    char stringdata0[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BlankPlanCreator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BlankPlanCreator_t qt_meta_stringdata_BlankPlanCreator = {
    {
QT_MOC_LITERAL(0, 0, 16), // "BlankPlanCreator"
QT_MOC_LITERAL(1, 17, 10), // "createPlan"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 14), // "QGeoCoordinate"
QT_MOC_LITERAL(4, 44, 14) // "mapCenterCoord"

    },
    "BlankPlanCreator\0createPlan\0\0"
    "QGeoCoordinate\0mapCenterCoord"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_BlankPlanCreator[] = {
...
QT_INIT_METAOBJECT const QMetaObject BlankPlanCreator::staticMetaObject = { {
    QMetaObject::SuperData::link<PlanCreator::staticMetaObject>(),
    qt_meta_stringdata_BlankPlanCreator.data,
    qt_meta_data_BlankPlanCreator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *BlankPlanCreator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BlankPlanCreator.stringdata0))
